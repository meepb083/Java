...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        database[0] = new BankAccount("Name1", "Name1", 1111, 10000.0);
        database[1] = new BankAccount("Name2", "Name2", 2222, 5500.0);
        database[2] = new BankAccount("Name3", "Name3", 3333, 15000.0);
        database[3] = new BankAccount("Name4", "Name4", 4444, 20000.0);
        database[4] = new BankAccount("Name5", "Name5", 5555, 50000.0);
